...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Materiales.color'
        db.add_column(u'inventario_materiales', 'color',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['util.Color'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Materiales.color'
        db.delete_column(u'inventario_materiales', 'color_id')
