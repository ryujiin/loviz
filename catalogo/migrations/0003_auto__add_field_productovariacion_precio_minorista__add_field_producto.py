...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductoVariacion.precio_minorista'
        db.add_column(u'catalogo_productovariacion', 'precio_minorista',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductoVariacion.oferta'
        db.add_column(u'catalogo_productovariacion', 'oferta',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductoVariacion.precio_minorista'
        db.delete_column(u'catalogo_productovariacion', 'precio_minorista')

        # Deleting field 'ProductoVariacion.oferta'
        db.delete_column(u'catalogo_productovariacion', 'oferta')
