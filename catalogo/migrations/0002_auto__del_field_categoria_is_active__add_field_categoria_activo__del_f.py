...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Categoria.is_active'
        db.delete_column(u'catalogo_categoria', 'is_active')

        # Adding field 'Categoria.activo'
        db.add_column(u'catalogo_categoria', 'activo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'ProductoVariacion.oferta_variante'
        db.delete_column(u'catalogo_productovariacion', 'oferta_variante')

        # Deleting field 'ProductoVariacion.precio_variante'
        db.delete_column(u'catalogo_productovariacion', 'precio_variante')

        # Deleting field 'ProductoVariacion.stock'
        db.delete_column(u'catalogo_productovariacion', 'stock')

        # Adding field 'Producto.full_name'
        db.add_column(u'catalogo_producto', 'full_name',
                      self.gf('django.db.models.fields.CharField')(max_length=120, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Categoria.is_active'
        db.add_column(u'catalogo_categoria', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Categoria.activo'
        db.delete_column(u'catalogo_categoria', 'activo')

        # Adding field 'ProductoVariacion.oferta_variante'
        db.add_column(u'catalogo_productovariacion', 'oferta_variante',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProductoVariacion.precio_variante'
        db.add_column(u'catalogo_productovariacion', 'precio_variante',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'ProductoVariacion.stock'
        db.add_column(u'catalogo_productovariacion', 'stock',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Producto.full_name'
        db.delete_column(u'catalogo_producto', 'full_name')
