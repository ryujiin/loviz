...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Producto', fields ['nombre']
        db.delete_unique(u'catalogo_producto', ['nombre'])


    def backwards(self, orm):
        # Adding unique constraint on 'Producto', fields ['nombre']
        db.create_unique(u'catalogo_producto', ['nombre'])
