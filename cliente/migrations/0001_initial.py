...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cliente_direccion', (
            ...
            ('distrito_peru', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ubigeo.Ubigeo'], null=True, blank=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('invitado', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'cliente', ['Direccion'])


    def backwards(self, orm):
        # Deleting model 'Direccion'
        db.delete_table(u'cliente_direccion')
