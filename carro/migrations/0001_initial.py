...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Carro'
        db.create_table(u'carro_carro', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('propietario', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Carrito', null=True, to=orm['auth.User'])),
            ('sesion_carro', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('estado', self.gf('django.db.models.fields.CharField')(default='Abierto', max_length=128)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_submitted', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'carro', ['Carro'])

        # Adding model 'LineaCarro'
        db.create_table(u'carro_lineacarro', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('carro', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carro.Carro'])),
            ('producto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogo.Producto'], null=True, blank=True)),
            ('variacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogo.ProductoVariacion'], null=True, blank=True)),
            ('cantidad', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('moneda', self.gf('django.db.models.fields.CharField')(default='S/.', max_length=120)),
            ('precio_unitario', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'carro', ['LineaCarro'])


    def backwards(self, orm):
        # Deleting model 'Carro'
        db.delete_table(u'carro_carro')

        # Deleting model 'LineaCarro'
        db.delete_table(u'carro_lineacarro')
    ...
    models = {
        ...
        u'carro.lineacarro': {
            ...
            'carro': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['carro.Carro']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
