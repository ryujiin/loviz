...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LineaCarro.moneda'
        db.delete_column(u'carro_lineacarro', 'moneda')

        # Deleting field 'LineaCarro.precio_unitario'
        db.delete_column(u'carro_lineacarro', 'precio_unitario')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'LineaCarro.moneda'
        db.add_column(u'carro_lineacarro', 'moneda',
                      self.gf('django.db.models.fields.CharField')(default='S/.', max_length=120),
                      keep_default=False)

        # Adding field 'LineaCarro.precio_unitario'
        db.add_column(u'carro_lineacarro', 'precio_unitario',
